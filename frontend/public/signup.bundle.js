...
/***/ "./frontend/src/ts/pages/signup/signupEntry.ts":
/*!*****************************************************!*\
  !*** ./frontend/src/ts/pages/signup/signupEntry.ts ***!
  \*****************************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _toggleVisibPass_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toggleVisibPass.ts */ \"./frontend/src/ts/pages/signup/toggleVisibPass.ts\");\n/* harmony import */ var _toggleVisibPass_ts__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_toggleVisibPass_ts__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _validate_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./validate.ts */ \"./frontend/src/ts/pages/signup/validate.ts\");\n\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./frontend/src/ts/pages/signup/signupEntry.ts\n");

/***/ }),

/***/ "./frontend/src/ts/pages/signup/signupUser.ts":
/*!****************************************************!*\
  !*** ./frontend/src/ts/pages/signup/signupUser.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ \"./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/regenerator */ \"./node_modules/@babel/runtime/regenerator/index.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _utils_setGetState_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../utils/setGetState.ts */ \"./frontend/src/ts/utils/setGetState.ts\");\n/* harmony import */ var _utils_showNotif_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/showNotif.ts */ \"./frontend/src/ts/utils/showNotif.ts\");\n\n\n\n\nvar signupUser = /*#__PURE__*/function () {\n  var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(jsonData) {\n    var response, result;\n    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {\n      while (1) switch (_context.prev = _context.next) {\n        case 0:\n          _context.prev = 0;\n          _context.next = 3;\n          return fetch(\"/api/v1/auth/signup\", {\n            method: \"POST\",\n            headers: {\n              \"Content-Type\": \"application/json\"\n            },\n            body: JSON.stringify(jsonData),\n            credentials: \"include\"\n          });\n        case 3:\n          response = _context.sent;\n          console.log({\n            response: response\n          });\n          _context.next = 7;\n          return response.json();\n        case 7:\n          result = _context.sent;\n          if (response.ok) {\n            _context.next = 13;\n            break;\n          }\n          console.error(\"Signup failed:\", result.message || \"Unknown error\");\n          (0,_utils_showNotif_ts__WEBPACK_IMPORTED_MODULE_3__.notifyError)(result.message || \"Signup failed\");\n          (0,_utils_setGetState_ts__WEBPACK_IMPORTED_MODULE_2__.setState)(\"isLoggedIn\", false);\n          //document.cookie =\n          //  \"authorization=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;\";\n          return _context.abrupt(\"return\");\n        case 13:\n          // saving this for illusory transcedental notif accross pages\n          sessionStorage.setItem(\"signupSuccessNotif\", \"Account created successfully!\");\n          (0,_utils_setGetState_ts__WEBPACK_IMPORTED_MODULE_2__.setState)(\"isLoggedIn\", true);\n          console.log(\"Signup successful\", result);\n          (0,_utils_showNotif_ts__WEBPACK_IMPORTED_MODULE_3__.notifySuccess)(\"Account created successfully!\");\n          window.location.href = \"/home\";\n          _context.next = 26;\n          break;\n        case 20:\n          _context.prev = 20;\n          _context.t0 = _context[\"catch\"](0);\n          console.error(\"Network error:\", _context.t0);\n          (0,_utils_showNotif_ts__WEBPACK_IMPORTED_MODULE_3__.notifyError)(\"Something went wrong, please try again later.\");\n          (0,_utils_setGetState_ts__WEBPACK_IMPORTED_MODULE_2__.setState)(\"isLoggedIn\", false);\n          //document.cookie =\n          //  \"authorization=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;\";\n          return _context.abrupt(\"return\");\n        case 26:\n        case \"end\":\n          return _context.stop();\n      }\n    }, _callee, null, [[0, 20]]);\n  }));\n  return function signupUser(_x) {\n    return _ref.apply(this, arguments);\n  };\n}();\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (signupUser);//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./frontend/src/ts/pages/signup/signupUser.ts\n");

/***/ }),

/***/ "./frontend/src/ts/pages/signup/toggleVisibPass.ts":
/*!*********************************************************!*\
  !*** ./frontend/src/ts/pages/signup/toggleVisibPass.ts ***!
  \*********************************************************/
/***/ (() => {

eval("document.addEventListener(\"DOMContentLoaded\", function () {\n  var toggleBtn = document.querySelector(\".visib-pass-btn\");\n  var passwordInputs = document.querySelectorAll('input[type=\"password\"]');\n  if (!toggleBtn || !passwordInputs) return;\n  toggleBtn.onclick = function () {\n    toggleBtn.classList.toggle(\"active\");\n    passwordInputs.forEach(function (input) {\n      var isPassword = input.type === \"password\";\n      input.type = isPassword ? \"text\" : \"password\";\n    });\n  };\n});//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./frontend/src/ts/pages/signup/toggleVisibPass.ts\n");

/***/ }),

/***/ "./frontend/src/ts/pages/signup/validate.ts":
/*!**************************************************!*\
  !*** ./frontend/src/ts/pages/signup/validate.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ \"./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/regenerator */ \"./node_modules/@babel/runtime/regenerator/index.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _signupUser_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./signupUser.ts */ \"./frontend/src/ts/pages/signup/signupUser.ts\");\n\n\n\n//import process from \"process\";\n//import dotenv from \"dotenv\";\n//dotenv.config();\n\ndocument.addEventListener(\"DOMContentLoaded\", function () {\n  //WARN: this is for quick testing only and should be removed on prod\n  //autoFillForm();\n\n  var form = document.getElementById(\"signup-form\");\n  if (!form) return;\n\n  // Helper function to show error\n  function showError(input, message) {\n    var errorDiv = document.querySelector(\".signup-error-msg[data-error-for=\\\"\".concat(input.name, \"\\\"]\"));\n    if (errorDiv) {\n      errorDiv.textContent = message;\n    }\n    input.classList.add(\"invalid\");\n  }\n\n  // Helper function to clear error\n  function clearError(input) {\n    var errorDiv = document.querySelector(\".signup-error-msg[data-error-for=\\\"\".concat(input.name, \"\\\"]\"));\n    if (errorDiv) {\n      errorDiv.textContent = \"\";\n    }\n    input.classList.remove(\"invalid\");\n  }\n  function validateField(field) {\n    var value = field.value.trim();\n    var name = field.name;\n    var passwordField = form === null || form === void 0 ? void 0 : form.elements.namedItem(\"password\");\n    switch (name) {\n      case \"username\":\n        if (!value) {\n          showError(field, \"field can't be empty.\");\n        } else if (!field.validity.valid) {\n          showError(field, \"username must be at least 4 characters long.\");\n        } else {\n          clearError(field);\n        }\n        break;\n      case \"email\":\n        if (!value) {\n          showError(field, \"field can't be empty.\");\n        } else if (!field.validity.valid) {\n          showError(field, \"not a valid email.\");\n        } else {\n          clearError(field);\n        }\n        break;\n      case \"password\":\n        if (!value) {\n          showError(field, \"field can't be empty.\");\n        } else if (value.length < 8) {\n          showError(field, \"password must be at least 8 characters long.\");\n        } else {\n          clearError(field);\n        }\n        break;\n      case \"confirmPassword\":\n        if (!value) {\n          showError(field, \"field can't be empty.\");\n        } else if (passwordField && passwordField.value && value !== passwordField.value.trim()) {\n          showError(field, \"passwords do not match.\");\n        } else {\n          clearError(field);\n        }\n        break;\n      default:\n        break;\n    }\n  }\n\n  // Attach validation handlers (live validation on input activities)\n  var _loop = function _loop() {\n    var field = _Array$from[_i];\n    if (field instanceof HTMLInputElement) {\n      field.addEventListener(\"input\", function () {\n        return validateField(field);\n      });\n    }\n  };\n  for (var _i = 0, _Array$from = Array.from(form.elements); _i < _Array$from.length; _i++) {\n    _loop();\n  }\n\n  // Form submission handler\n  form.addEventListener(\"submit\", /*#__PURE__*/function () {\n    var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(e) {\n      var hasErrors, _i2, _Array$from2, field, formData, jsonData;\n      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {\n        while (1) switch (_context.prev = _context.next) {\n          case 0:\n            e.preventDefault();\n\n            // Validate all fields\n            hasErrors = false;\n            for (_i2 = 0, _Array$from2 = Array.from(form.elements); _i2 < _Array$from2.length; _i2++) {\n              field = _Array$from2[_i2];\n              if (field instanceof HTMLInputElement) {\n                validateField(field);\n                if (!field.validity.valid || field.classList.contains(\"invalid\")) {\n                  hasErrors = true;\n                }\n              }\n            }\n            if (!hasErrors) {\n              _context.next = 5;\n              break;\n            }\n            return _context.abrupt(\"return\");\n          case 5:\n            formData = new FormData(form); //console.log({ formData });\n            jsonData = Object.fromEntries(formData); //console.log({ jsonData });\n            form.reset();\n            _context.next = 10;\n            return (0,_signupUser_ts__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(jsonData);\n          case 10:\n          case \"end\":\n            return _context.stop();\n        }\n      }, _callee);\n    }));\n    return function (_x) {\n      return _ref.apply(this, arguments);\n    };\n  }());\n});//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./frontend/src/ts/pages/signup/validate.ts\n");
...
/******/ 	(() => {
/******/ 		__webpack_require__.hmrF = () => ("signup." + __webpack_require__.h() + ".hot-update.json");
/******/ 	})();
/******/ 	
...
/******/ 	var __webpack_exports__ = __webpack_require__("./frontend/src/ts/pages/signup/signupEntry.ts");
/******/ 	
/******/ })()
;